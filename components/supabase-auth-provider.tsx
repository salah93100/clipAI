      ...
      try {
        ...
        const { data: { subscription } } = supabase.auth.onAuthStateChange(
          async (event, session) => {
            ...
            if (event === 'SIGNED_IN') {
              console.log("Session établie après connexion");
              
              // Éviter de rediriger si nous sommes déjà sur dashboard
              if (pathname && pathname.startsWith('/dashboard')) {
                console.log("Déjà sur dashboard, pas de redirection nécessaire");
                router.refresh();
                return;
              }
